  ...
  return (
    <div style={{ minHeight: '100dvh', background: C.paper, color: C.inkMid, fontFamily: SANS }}>
      <div style={{ maxWidth: '780px', margin: '0 auto', padding: '0 clamp(16px, 5vw, 32px) clamp(40px, 6vw, 64px)' }}>
        ...
        {/* ════════════════════════════════════════════════════════════════════
            SECTION 5 — BRAIN CONTRIBUTORS
        ═══════════════════════════════════════════════════════════════════════ */}
        <div style={{ marginTop: 'clamp(32px, 5vw, 52px)' }}>
          <SectionLabel id="brain" emoji="🧠" title="Brain Contributors" color={C.brain.line} bg={C.brain.bg} />
        </div>
        <div style={{ marginTop: 'clamp(20px, 3vw, 28px)' }}>
          <div style={{ fontFamily: SERIF, fontSize: '15px', color: C.inkMid, lineHeight: 1.65, marginBottom: '18px' }}>
            No manual contributions this week — the Brain ran on autopilot.
          </div>
          <div style={{ fontFamily: SANS, fontSize: '13px', color: C.inkDim, lineHeight: 1.65,
            borderTop: `1px solid ${C.paperDark}`, paddingTop: '14px', marginBottom: '18px' }}>
            The Kinship Workflows bot auto-logged 20 meeting transcripts and call summaries into the Brain this week, including the Weekly Pipeline Review, RHA Planning Session, International Market Penetration Huddle, All-Hands, and 16 other sessions. The Brain is getting fed — just not manually.
          </div>
          <div style={{ background: C.paperWarm, borderTop: `1px solid ${C.paperDark}`, padding: 'clamp(12px, 2vw, 18px)' }}>
            <div style={{ fontFamily: SANS, fontWeight: 700, fontSize: '11px', letterSpacing: '0.1em',
              textTransform: 'uppercase' as const, color: C.brain.line, marginBottom: '10px' }}>
              Auto-logged via Kinship Workflows this week
            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap' as const, gap: '6px 12px' }}>
              {[
                ...
                'Onboarding Call: Paul & Azim', 'Lindsey / Dave - quick huddle RE: Rashi',
                '30 min with Azim (Brenda Montgomery)', 'Maggie / Dave - quick huddle',
                'Azim / Lindsey - Connect on SOP', 'International Market Penetration Huddle',
                'Sales Daily', 'Dan / Lindsey Connect on Strategy', 'nadim x tyler',
                'Baypoint / kinship - follow-up', 'Omar / Dave Connect Call',
                'RHA x kinship planning session', 'Prod Eng Daily Standup',
                'Weekly Pipeline Review', 'Slope School / kinship demo',
              ].map((entry) => (
                <div key={entry} style={{ fontFamily: MONO, fontSize: '11px', color: C.inkDim,
                  background: C.white, padding: '4px 8px', border: `1px solid ${C.paperDark}` }}>
                  {entry}
                </div>
              ))}
            </div>
          </div>
          <div style={{ fontFamily: SANS, fontSize: '12px', color: C.inkFaint, marginTop: '14px', fontStyle: 'italic' }}>
            Want to show up here next week? Post a manual entry to <span style={{ fontFamily: MONO }}>#brain-changelog</span> with what you learned, a call note, or a useful link.
          </div>
        </div>
